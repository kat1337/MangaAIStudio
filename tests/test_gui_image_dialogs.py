...
Covers the TRACER rotate end-to-end (Task 1), and the Resize dialog + Show
Original gating (Task 3) against the real ``MainWindow`` (pytest-qt) with
``tmp_path`` fixture pages:
...
The Levels dialog lifecycle tests migrated to the CurvesDialog suite in plan
06-05 (the D-01 supersession) — they live in ``test_gui_curves_dialog.py``.
"""
