...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-09-07 - Completed quick task 260907-l3w: Open Folder now detects project vs plain folder (direct or one-subdir-deep manifest loads the project; plain folders load images + .mas pages, all-or-nothing; single Unsaved Changes gate per action); full suite 1292 passed (1 pre-existing env flake)
