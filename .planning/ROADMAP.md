...
- [ ] 05-01-PLAN.md — .mas serialization core: LZMA2 container + manifest + PageBox mapping + D-06 checksum + D-09 climb + validation (PROJ-01)
...
| 5. Project Persistence, Image Ops & Export | 0/8 | Not started | - |
